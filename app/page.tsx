...
const features = [
  ...
  },
  {
    ...
    description:
      'Engage in deep conversations about your content strategy, brainstrom ideas, and unlock new creative possibilities with your AI agent companion',
    icon: Sparkles,
...
const steps = [
  {
    ...
    description: 'Share yout YouTube video URL ans let your agent get to work',
    icon: Video,
  },
  {
    title: '1. AI Agent Analysis',
    description: 'Your personal agent analyzes every aspect of your content',
    icon: Brain,
  },
  {
    title: '1. Receive Intelligence',
